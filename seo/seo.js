...
Sitemap: https://www.pencmi.com/sitemap.xml`,
  publicMeta: {
    ...
    "/hotels": {
      ...
      description: "Trouvez des hôtels, auberges, résidences et appartements meublés au Sénégal sur Péncmi.",
    ...
    "/mentions-legales": {
      ...
      description: "Consultez les mentions légales de Péncmi.",
      h1: "Mentions légales",
      indexing: "index",
      schemaType: "WebPage"
    },
    ...
    "/regles-publication": {
      ...
      description: "Consultez les règles de publication des annonces immobilières, hôtels, voitures et voyages sur Péncmi.",
    ...
    "/guide/immobilier-senegal": {
      ...
      description: "Guide pour comprendre la recherche immobilière au Sénégal avec Péncmi.",
    ...
    "/guide/location-appartement-senegal": {
      ...
      description: "Guide pour rechercher une location d’appartement au Sénégal avec Péncmi.",
    ...
    "/guide/acheter-terrain-senegal": {
      ...
      description: "Guide pour comprendre la recherche et les précautions autour d’un terrain au Sénégal.",
    ...
    "/guide/trouver-hotel-senegal": {
      ...
      description: "Guide pour rechercher un hôtel, une auberge ou une résidence au Sénégal.",
    ...
    "/guide/louer-voiture-senegal": {
      ...
      description: "Guide pour rechercher une voiture à louer au Sénégal avec Péncmi.",
    ...
    "/guide/voiture-avec-chauffeur-senegal": {
      ...
      description: "Guide pour comprendre les offres de voiture avec chauffeur au Sénégal.",
    ...
    "/guide/voyage-interurbain-senegal": {
      ...
      description: "Guide pour rechercher un trajet interurbain au Sénégal avec Péncmi.",
    ...
    "/guide/dakar-touba": {
      ...
      description: "Guide pour comprendre la recherche de trajet Dakar Touba avec Péncmi.",
    ...
    "/guide/securite-annonces-senegal": {
      ...
      description: "Guide sur les précautions à prendre avant de contacter un annonceur au Sénégal.",
